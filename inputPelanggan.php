<?php
include("connect1.php"); //koneksi ke database
...
//kondisi jika data masih ada yang kosong harus di isi dulu 
if (trim($kode)=="") {
...
$input="insert into tbbarang (kode,nama,deskripsi,stok,harga,berat)
